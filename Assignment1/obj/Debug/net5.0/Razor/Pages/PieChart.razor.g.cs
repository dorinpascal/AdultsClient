#pragma checksum "C:\Users\User\RiderProjects\Assignment1\Assignment1\Pages\PieChart.razor" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "39dd2a18a3eda8b171d68445ec91cb19a999c3d2"
// <auto-generated/>
...
#nullable restore
#line 11 "C:\Users\User\RiderProjects\Assignment1\Assignment1\Pages\PieChart.razor"
                   pieConfig
...
#line 14 "C:\Users\User\RiderProjects\Assignment1\Assignment1\Pages\PieChart.razor"
    ...
    private void ConfigurePieChart()
    {
        ...
        foreach (var adults in FileContext.Adults)
        {
            ...
            else if (adults.Age > 18 && adults.Age < 27)
            {
                semiMedium++;
            }
        ...
        foreach (var age in new[] {"Younger than 18 ", "Between 18-27 ", "Between 27-35 ", "Between 35-50 ", "50+ "})
        {
            pieConfig.Data.Labels.Add(age);
        }
        var dataset = new PieDataset<int>(new[] {young, semiMedium, medium, semiOld, old})
        {
            BackgroundColor = new[]
            {
                ...
                ColorUtil.ColorHexString(73, 50, 28)
            }
        };
